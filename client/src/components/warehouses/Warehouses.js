        ...
        <div className="warehouses-wrapper">
          ...
          <div className="warehouses-item-wrapper">
            <div className="warehouses__warehouse-item" id="table-labels">
              ...
              <div className="arrow-right-placeholder" />
            </div>
                ...
                <form className="modal-form" id="modal-form">
                  ...
                  <div className="fourth-form-div">
                    <div className="phNumber-div">
                      <label
                        className="phNumber-label"
                        htmlFor="phNumber-switch"
                      >
                        PHONE NUMBER
                      </label>
                      <input
                        className="phNumber-input"
                        type="text"
                        name="phNumber-input"
                        id="phNumber-input"
